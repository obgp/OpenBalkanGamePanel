							...
							<div class="widget-content">
								<div id="plugin_body">
			                        ...
			                        <?php
			                            ...
			                            $gp_mods 	= mysql_query("SELECT * FROM `modovi` WHERE `igra` = '$g_id'");
			                            $MID = 1;
			                            ...
			                            if ($mm_id == $Mod_ID) { ?>
			                                <li>
			                                	<form action="" method="POST" autocomplete="off">
			                                        ...
			                                        <input style="display:none;" type="text" name="mod_id" value="<?php echo $Mod_ID; ?>">
			                                        <button disabled="" class="right btn_inst_active">INSTALIRAN <i class="fa fa-remove"></i></button>
			                                    </form>
			                            ...
			                            <?php } else { ?>
			                                <li>
			                                	<form action="/admin/process.php?s=server_reinstall" method="POST" autocomplete="off">
			                                        <input style="display:none;" type="text" name="server_id" value="<?php echo $Server_ID; ?>">
			                                        <input style="display:none;" type="text" name="mod_id" value="<?php echo $Mod_ID; ?>">
