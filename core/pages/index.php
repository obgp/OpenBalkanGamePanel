...
<nav class="navbar" style="margin-top:10%">
	...
	<div id="navbar" class="navbar-offcanvas" data-direction="left">
		...
		<ul class="nav navbar-nav">
			<img class="visible-xs text-center" style="text-align: center;display: inline-block;margin: 0 auto;" src="https://i.imgur.com/unnxAPA.png">
			<li><a href="/"><i class="fas fa-home"></i> Početna</a></li>
			<li><a href="/home"><i class="fab fa-windows"></i> Game Panel</a></li>
			<li><a href="/order"><i class="fas fa-shopping-basket"></i> Naruči server</a></li>
		</ul>
		...
		<?php } else { ?>
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/logout"><i class="fas fa-key"></i> Logout</a></li>
			</ul>
			<?php } ?>
	</div>
</nav>			</div>
    		...
    		<div class="col-md-3">
    			<div class="panel panel-game">
    				...
    				<div class="panel-footer">
    					<a href="order?igrica=cs16" class="btn btn-purple btn-block"><i class="far fa-shopping-cart"></i>  Naruči server</a>
    				</div>
    			</div>
    		</div>
    		...
    		<div class="col-md-3">
    			<div class="panel panel-game">
    				...
    				<div class="panel-footer">
    					<a href="order?igrica=csgo" class="btn btn-purple btn-block"><i class="far fa-shopping-cart"></i>  Naruči server</a>
    				</div>
    			</div>
    		</div>
    		...
    		<div class="col-md-3">
    			<div class="panel panel-game">
    				...
    				<div class="panel-footer">
    					<a href="order?igrica=samp" class="btn btn-purple btn-block"><i class="far fa-shopping-cart"></i>  Naruči server</a>
    				</div>
    			</div>
    		</div>
    		...
    		<div class="col-md-3">
    			<div class="panel panel-game">
    				...
    				<div class="panel-footer">
    					<a href="order?igrica=mc" class="btn btn-purple btn-block"><i class="far fa-shopping-cart"></i>  Naruči server</a>
    				</div>
    			</div>
    		</div>
...
<div id="login" class="modal fade" role="dialog" style="margin-top: 100px;">
  	<div class="modal-dialog" style="width: 300px;max-width: 100%;margin-left: 15px;margin-right: 15px;display: block;margin: 0 auto;">
    	...
    	<div class="modal-content">
            ...
            <h1><i class="fas fa-users-cog"></i> Uloguj se <a href="/demo">(DEMO)</a></h1>   			
