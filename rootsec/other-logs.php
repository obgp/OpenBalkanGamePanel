...
if (isset($_GET['delete-all'])) {
    $table = $prefix . 'logs';
    $query = mysqli_query($connect, "DELETE FROM `$table` WHERE type='Bad Bot' or type='Fake Bot' or type='Missing User-Agent header' or type='TOR Detected' or type='Invalid IP Address header'");
}
?>
...
<?php
$table = $prefix . 'logs';
$sql   = mysqli_query($connect, "SELECT id, ip, date, browser, browser_code, os, os_code, country, country_code, type FROM `$table` WHERE type='Bad Bot' or type='Fake Bot' or type='Missing User-Agent header' or type='Missing header Accept' or type='TOR Detected' or type='Invalid IP Address header' ORDER by id DESC");
