...
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fa fa-lock"></i> Hashing</h1>
    			  <ol class="breadcrumb">
				...
				<div class="col-md-9">
				    <div class="box">
						<div class="box-header">
							<h3 class="box-title">Hash Encoder</h3>
						</div>
						<div class="box-body">
<?php
...
?></textarea>
                                        ...
                                        <br />
                                        <button type="submit" name="generate" class="btn btn-flat btn-primary"><i class="fa fa-refresh"></i> Generate Hash</button>
								    </form>
...
<td>hash</td>
				...
				<div class="col-md-3">
                     ...
                     <div class="box">
						<div class="box-header">
							<h3 class="box-title">Purposes</h3>
						</div>
				        <div class="box-body">
